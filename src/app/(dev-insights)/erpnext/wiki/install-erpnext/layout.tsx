...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "install-erpnext");
  const faqsGroup = await getFaqs("Code Snippet", "install-erpnext");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00062" type="code-snippet" />  
      
    <FooterSection doctype="Code Snippet" docname="install-erpnext" />
    </>
  );
}