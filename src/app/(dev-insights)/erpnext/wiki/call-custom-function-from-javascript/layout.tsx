...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "call-custom-function-from-javascript");
  const faqsGroup = await getFaqs("Code Snippet", "call-custom-function-from-javascript");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00085" type="code-snippet" />  
      
    <FooterSection doctype="Code Snippet" docname="call-custom-function-from-javascript" />
    </>
  );
}