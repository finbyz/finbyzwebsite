...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "get-contact-details-from-party");
  const faqsGroup = await getFaqs("Code Snippet", "get-contact-details-from-party");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00073" type="code-snippet" />  
      
    <FooterSection doctype="Code Snippet" docname="get-contact-details-from-party" />
    </>
  );
}