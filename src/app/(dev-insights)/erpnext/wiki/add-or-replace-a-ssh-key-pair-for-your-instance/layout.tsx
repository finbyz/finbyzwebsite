...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "add-or-replace-a-ssh-key-pair-for-your-instance");
  const faqsGroup = await getFaqs("Code Snippet", "add-or-replace-a-ssh-key-pair-for-your-instance");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00447" type="code-snippet" />  
      
    <FooterSection doctype="Code Snippet" docname="add-or-replace-a-ssh-key-pair-for-your-instance" />
    </>
  );
}