...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "address-and-contact-details");
  const faqsGroup = await getFaqs("Code Snippet", "address-and-contact-details");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00099" type="code-snippet" />  
      
    <FooterSection doctype="Code Snippet" docname="address-and-contact-details" />
    </>
  );
}