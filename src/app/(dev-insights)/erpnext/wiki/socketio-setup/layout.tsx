...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "socketio-setup");
  const faqsGroup = await getFaqs("Code Snippet", "socketio-setup");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00066" type="code-snippet" />  
      
    <FooterSection doctype="Code Snippet" docname="socketio-setup" />
    </>
  );
}