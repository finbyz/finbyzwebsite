...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "count-within-loop-print-outside-loop");
  const faqsGroup = await getFaqs("Code Snippet", "count-within-loop-print-outside-loop");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00098" type="code-snippet" />  
      
    <FooterSection doctype="Code Snippet" docname="count-within-loop-print-outside-loop" />
    </>
  );
}