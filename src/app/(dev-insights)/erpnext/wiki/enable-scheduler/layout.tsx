...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "enable-scheduler");
  const faqsGroup = await getFaqs("Code Snippet", "enable-scheduler");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00064" type="code-snippet" />  
      
    <FooterSection doctype="Code Snippet" docname="enable-scheduler" />
    </>
  );
}