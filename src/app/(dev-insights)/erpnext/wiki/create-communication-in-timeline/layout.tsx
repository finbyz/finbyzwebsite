...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "create-communication-in-timeline");
  const faqsGroup = await getFaqs("Code Snippet", "create-communication-in-timeline");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00097" type="code-snippet" />  
      
    <FooterSection doctype="Code Snippet" docname="create-communication-in-timeline" />
    </>
  );
}