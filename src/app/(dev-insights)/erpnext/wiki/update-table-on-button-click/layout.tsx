...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "update-table-on-button-click");
  const faqsGroup = await getFaqs("Code Snippet", "update-table-on-button-click");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00090" type="code-snippet" />  
      
    <FooterSection doctype="Code Snippet" docname="update-table-on-button-click" />
    </>
  );
}