...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "resolve-update-errors");
  const faqsGroup = await getFaqs("Code Snippet", "resolve-update-errors");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00069" type="code-snippet" />  
      
    <FooterSection doctype="Code Snippet" docname="resolve-update-errors" />
    </>
  );
}