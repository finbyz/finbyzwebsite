...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "calendar-view-method");
  const faqsGroup = await getFaqs("Code Snippet", "calendar-view-method");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00096" type="code-snippet" />  
      
    <FooterSection doctype="Code Snippet" docname="calendar-view-method" />
    </>
  );
}