...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "change-site-name");
  const faqsGroup = await getFaqs("Code Snippet", "change-site-name");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00065" type="code-snippet" />  
      
    <FooterSection doctype="Code Snippet" docname="change-site-name" />
    </>
  );
}