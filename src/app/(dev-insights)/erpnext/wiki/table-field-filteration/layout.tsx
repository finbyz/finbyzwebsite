...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "table-field-filteration");
  const faqsGroup = await getFaqs("Code Snippet", "table-field-filteration");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00083" type="code-snippet" />  
      
    <FooterSection doctype="Code Snippet" docname="table-field-filteration" />
    </>
  );
}