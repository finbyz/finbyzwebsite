...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "error:-no-module-named-psutil");
  const faqsGroup = await getFaqs("Code Snippet", "error:-no-module-named-psutil");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00070" type="code-snippet" />  
      
    <FooterSection doctype="Code Snippet" docname="error:-no-module-named-psutil" />
    </>
  );
}