...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "enable-developer-mode");
  const faqsGroup = await getFaqs("Code Snippet", "enable-developer-mode");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00071" type="code-snippet" />  
      
    <FooterSection doctype="Code Snippet" docname="enable-developer-mode" />
    </>
  );
}