...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "create-swap-file");
  const faqsGroup = await getFaqs("Code Snippet", "create-swap-file");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00067" type="code-snippet" />  
      
    <FooterSection doctype="Code Snippet" docname="create-swap-file" />
    </>
  );
}