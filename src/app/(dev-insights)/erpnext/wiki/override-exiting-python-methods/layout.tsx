...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "override-exiting-python-methods");
  const faqsGroup = await getFaqs("Code Snippet", "override-exiting-python-methods");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00084" type="code-snippet" />  
      
    <FooterSection doctype="Code Snippet" docname="override-exiting-python-methods" />
    </>
  );
}