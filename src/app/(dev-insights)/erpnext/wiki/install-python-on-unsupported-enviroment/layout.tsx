...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "install-python-on-unsupported-enviroment");
  const faqsGroup = await getFaqs("Code Snippet", "install-python-on-unsupported-enviroment");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00501" type="code-snippet" />  
      
    <FooterSection doctype="Code Snippet" docname="install-python-on-unsupported-enviroment" />
    </>
  );
}