...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "using-where-clause-in-sql");
  const faqsGroup = await getFaqs("Code Snippet", "using-where-clause-in-sql");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00091" type="code-snippet" />  
      
    <FooterSection doctype="Code Snippet" docname="using-where-clause-in-sql" />
    </>
  );
}