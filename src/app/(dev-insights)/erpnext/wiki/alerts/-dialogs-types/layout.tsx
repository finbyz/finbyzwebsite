...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "alerts/-dialogs-types");
  const faqsGroup = await getFaqs("Code Snippet", "alerts/-dialogs-types");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00078" type="code-snippet" />  
      
    <FooterSection doctype="Code Snippet" docname="alerts/-dialogs-types" />
    </>
  );
}