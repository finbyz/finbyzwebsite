...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "restrict-users-to-add/delete-rows");
  const faqsGroup = await getFaqs("Code Snippet", "restrict-users-to-add/delete-rows");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00076" type="code-snippet" />  
      
    <FooterSection doctype="Code Snippet" docname="restrict-users-to-add/delete-rows" />
    </>
  );
}