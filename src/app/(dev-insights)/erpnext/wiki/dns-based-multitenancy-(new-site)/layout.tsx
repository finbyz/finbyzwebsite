...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "dns-based-multitenancy-(new-site)");
  const faqsGroup = await getFaqs("Code Snippet", "dns-based-multitenancy-(new-site)");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00061" type="code-snippet" />  
      
    <FooterSection doctype="Code Snippet" docname="dns-based-multitenancy-(new-site)" />
    </>
  );
}