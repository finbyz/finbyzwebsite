...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "gunicorn");
  const faqsGroup = await getFaqs("Code Snippet", "gunicorn");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00103" type="code-snippet" />  
      
    <FooterSection doctype="Code Snippet" docname="gunicorn" />
    </>
  );
}