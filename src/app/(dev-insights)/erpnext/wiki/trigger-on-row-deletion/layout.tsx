...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "trigger-on-row-deletion");
  const faqsGroup = await getFaqs("Code Snippet", "trigger-on-row-deletion");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00077" type="code-snippet" />  
      
    <FooterSection doctype="Code Snippet" docname="trigger-on-row-deletion" />
    </>
  );
}