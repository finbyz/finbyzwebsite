...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "custom-button");
  const faqsGroup = await getFaqs("Code Snippet", "custom-button");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00092" type="code-snippet" />  
      
    <FooterSection doctype="Code Snippet" docname="custom-button" />
    </>
  );
}