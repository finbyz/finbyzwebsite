...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "nginx-service");
  const faqsGroup = await getFaqs("Code Snippet", "nginx-service");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00068" type="code-snippet" />  
      
    <FooterSection doctype="Code Snippet" docname="nginx-service" />
    </>
  );
}