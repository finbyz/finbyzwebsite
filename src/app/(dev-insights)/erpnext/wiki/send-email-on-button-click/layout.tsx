...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "send-email-on-button-click");
  const faqsGroup = await getFaqs("Code Snippet", "send-email-on-button-click");
  ...
  return (
    ...
    <FooterSection doctype="Code Snippet" docname="send-email-on-button-click" />
    </>
  );
}