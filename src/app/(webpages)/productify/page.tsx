        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col items-center">
            <div className="w-full aspect-square overflow-hidden rounded-lg shadow-lg">
              <Image fill  src="/images/Productify%20Applications%20Used.jpg" alt="Productify Applications Used" />
            </div>
          ...
          <div className="flex flex-col items-center">
            <div className="w-full aspect-square overflow-hidden rounded-lg shadow-lg">
              <Image fill  src="/images/Productify%20Web%20Browsing%20Time.jpg" alt="Productify Web Browsing Time" />
            </div>
            <p className="mt-4 text-center text-muted-foreground text-sm">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
      ...
      <div className="flex flex-col items-center">
        <div className="w-full max-w-md overflow-hidden rounded-lg shadow-lg bg-white p-4">
          <Image fill  src="/images/Productify%20Top%20Phone%20Calls.jpg" alt="Productify Top Phone Calls" />
        </div>
        <p className="mt-4 text-center text-muted-foreground text-sm">
      ...
      <div className="flex flex-col items-center">
        <div className="w-full max-w-sm overflow-hidden rounded-lg shadow-lg bg-white p-4">
          <Image fill  src="/images/Type%20of%20Calls.png" alt="Type of Calls" />
        </div>
        <p className="mt-4 text-center text-muted-foreground text-sm">
