...
export async function generateMetadata(): Promise<Metadata> {
  const pageData = await fetchFrappeSchemaData({
    name: "fd-management-in-the-erpnext",
    type: "webpage"
  })
...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Web Page", "erpnext/apps/fd-management-erpnext");
  const faqsGroup = await getFaqs("Web Page", "erpnext/apps/fd-management-erpnext");
  ...
  return (
    <>
      <main>
        ...
        <BusinessSlider />
        <StructureData name="fd-management-in-the-erpnext" type="webpage" />
