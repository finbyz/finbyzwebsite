...
export async function generateMetadata(): Promise<Metadata> {
  const pageData = await fetchFrappeSchemaData({
    name: "advanced-authorisation-licence-in-erpnext",
    type: "webpage"
  })
...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Web Page", "erpnext/apps/advanced-authorisation-licence-erpnext");
  const faqsGroup = await getFaqs("Web Page", "erpnext/apps/advanced-authorisation-licence-erpnext");
  ...
  return (
    <>
      <main>
        ...
        <BusinessSlider />
        <StructureData name="advanced-authorisation-licence-in-erpnext" type="webpage" />
