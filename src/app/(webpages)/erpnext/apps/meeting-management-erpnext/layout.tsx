...
export async function generateMetadata(): Promise<Metadata> {
  const pageData = await fetchFrappeSchemaData({
    name: "meeting-management-in-erpnext",
    type: "webpage"
  })
...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Web Page", "erpnext/apps/meeting-management-erpnext");
  const faqsGroup = await getFaqs("Web Page", "erpnext/apps/meeting-management-erpnext");
  ...
  return (
    <>
      <main>
        ...
        <BusinessSlider />
        <StructureData name="meeting-management-in-erpnext" type="webpage" />
