...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Web Page", "erpnext/agro/erp-for-commodity-trading");
  const faqsGroup = await getFaqs("Web Page", "erpnext/agro/erp-for-commodity-trading");
  ...
  return (
    <>
      ...
      <BusinessSlider />
      <StructureData name="erp-for-agro-commodity" type="webpage" />
    </>
  );
}
