...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Web Page", "erpnext/services/hire-erpnext-implementer");
  const faqsGroup = await getFaqs("Web Page", "erpnext/services/hire-erpnext-implementer");
  ...
  return (
    <>
      <main>
        ...
        <BusinessSlider />
        <StructureData name="hire-erpnext-implementer" type="webpage" />
