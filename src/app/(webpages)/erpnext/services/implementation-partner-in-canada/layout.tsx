...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Web Page", "erpnext/services/implementation-partner-in-canada");
  const faqsGroup = await getFaqs("Web Page", "erpnext/services/implementation-partner-in-canada");
  ...
  return (
    <>
      <main>
        ...
        <BusinessSlider />
        <StructureData name="erpnext-services-in-canada" type="webpage" />
