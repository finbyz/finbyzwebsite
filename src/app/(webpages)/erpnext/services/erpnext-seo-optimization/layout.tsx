...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Web Page", "erpnext/services/erpnext-seo-optimization");
  const faqsGroup = await getFaqs("Web Page", "erpnext/services/erpnext-seo-optimization");
  ...
  return (
    <>
      <main>
        ...
        <BusinessSlider />
        <StructureData name="erpnext-seo" type="webpage" />
