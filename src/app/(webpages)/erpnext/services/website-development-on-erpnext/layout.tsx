...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Web Page", "erpnext/services/website-development-on-erpnext");
  const faqsGroup = await getFaqs("Web Page", "erpnext/services/website-development-on-erpnext");
  ...
  return (
    <>
      <main>
        ...
        <BusinessSlider />
        <StructureData name="website-development" type="webpage" />
