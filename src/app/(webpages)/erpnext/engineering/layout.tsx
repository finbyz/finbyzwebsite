...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Web Page", "erpnext/engineering");
  const faqsGroup = await getFaqs("Web Page", "erpnext/engineering");
  ...
  return (
    <>
      <main>
        ...
        <BusinessSlider />
        <StructureData name="erp-for-engineering" type="webpage" />
