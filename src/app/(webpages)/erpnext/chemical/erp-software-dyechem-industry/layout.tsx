...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Web Page", "erpnext/chemical/erp-software-dyechem-industry");
  const faqsGroup = await getFaqs("Web Page", "erpnext/chemical/erp-software-dyechem-industry");
  ...
  return (
    <>
      ...
      <BusinessSlider />
      <StructureData name="chemical-industry" type="webpage" />
    </>
  );
}
