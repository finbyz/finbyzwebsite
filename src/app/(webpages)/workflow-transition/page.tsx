      ...
      <Section>
        <div className="container-custom py-8">
          ...
          <div className="flex justify-center animate-fade-in">
            <Image fill  src="/images/so.jpg" alt="Workflow Example" />
          </div>
        </div>
      </Section>
      ...
      <Section useGradient>
        <div className="container-custom py-8">
          ...
          <div className="flex justify-center mt-8 animate-fade-in">
            <Image fill  src="/images/ws.jpg" alt="Workflow State Tracking" />
          </div>
        </div>
      </Section>
      ...
      <Section>
        <div className="container-custom py-8">
          ...
          <div className="flex flex-col md:flex-row gap-6 justify-center items-center mt-8 animate-fade-in">
            <Image fill  src="/images/so_1.jpg" alt="Reminder Config 1" />
           </div>
           <div className="flex flex-col md:flex-row gap-6 justify-center items-center mt-8 animate-fade-in">
            <Image fill  src="/images/ds.jpg" alt="Reminder Config 2" />
            </div>
            <div className="flex flex-col md:flex-row gap-6 justify-center items-center mt-8 animate-fade-in">

            <Image fill  src="/images/so_2.jpg" alt="Reminder Config 3" />
            </div>
          ...
          />
          <div className="flex flex-col md:flex-row gap-6 justify-center items-center mt-8 animate-fade-in">
            <Image fill  src="/images/ps.jpg" alt="Project Permission 1" />
          </div>
          <div className="flex flex-col md:flex-row gap-6 justify-center items-center mt-8 animate-fade-in">
            <Image fill  src="/images/po.jpg" alt="Project Permission 2" />
          </div>
        </div>
      </Section>
      ...
      <Section useGradient>
        <div className="container-custom py-8">
          ...
          <div className="flex justify-center animate-fade-in mb-8">
            <Image fill  src="/images/state_change.jpg" alt="State Change Overview" />
          </div>
          ...
          <div className="mb-8">
            ...
            <div className="flex justify-center animate-fade-in mb-8">
              <Image fill  src="/images/state_change-1.jpg" alt="State Transition Time Report" />
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-6 justify-center items-center animate-fade-in">
            <Image fill  src="/images/state_change_report.jpg" alt="State Change Report 1" />
            </div>
            <br></br>
            <div className="flex flex-col md:flex-row gap-6 justify-center items-center animate-fade-in">
            <Image fill  src="/images/state_change_report_1.jpg" alt="State Change Report 2" />
            </div>
            <br></br>
            <div className="flex flex-col md:flex-row gap-6 justify-center items-center animate-fade-in">
            <Image fill  src="/images/expence_claim.jpg" alt="Expense Claim Report" />
          </div>
        </div>
      </Section>
