...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://web.finbyz.tech/smart-card-scanner-overview-test",
  },
  openGraph: {
    title: "Smart Card Scanner Overview",
    description: "Discover the Smart Card Scanner, an AI-driven tool for efficient business card management integrating with ERPNext for automated contact data extraction.",
    url: "https://web.finbyz.tech/smart-card-scanner-overview-test",
...
export default function Layout({ children }: { children: React.ReactNode }) {
  const structuredData = {
    ...
    "mainEntity": {
      ...
      "datePublished": "2025-10-15T08:45:02.100Z",
      "dateModified": "2025-10-15T08:45:02.100Z",
    }
  };
