...
export default async function Layout({ children }: { children: React.ReactNode }) {
    const data = await getPageData("Web Page", "ai-automation/services/data-analytics");
    const faqsGroup = await getFaqs("Web Page", "ai-automation/services/data-analytics");
    ...
    return (
        <>
            <main>
                ...
                <BusinessSlider />
                <StructureData name="data-analytics" type="webpage" />
