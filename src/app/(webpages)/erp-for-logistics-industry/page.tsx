      ...
      <Section useGradient>
        <div className="container-custom py-8 flex flex-col items-center">
          ...
          <div className="mt-8 text-base text-muted-foreground text-justify">
            ...
            <br />
            <p>
              Our logistics ERP system streamlines critical functions such as fleet management, inventory control, transportation tracking, and maintenance scheduling. With ERP software for logistics industry, including vertical solutions like <a href="/erp-for-chemical-industry" className="text-primary underline hover:text-primary-foreground transition-colors" target="_blank">ERP for Chemical Industry</a>, <a href="/erp-for-manufacturing-industry" className="text-primary underline hover:text-primary-foreground transition-colors" target="_blank">Manufacturing ERP</a>, <a href="/erp-for-engineering-industry" className="text-primary underline hover:text-primary-foreground transition-colors" target="_blank">Engineering ERP Software</a>, and <a href="/erp-for-trading-industry" className="text-primary underline hover:text-primary-foreground transition-colors" target="_blank">ERP for Trading</a>, businesses gain a unified platform that connects departments like <a href="/human-resource-system" className="text-primary underline hover:text-primary-foreground transition-colors" target="_blank">Human Resource Management</a>, finance, and marketing. This not only reduces manual documentation but also supports data-driven decision-making, resource optimization, and improved workforce productivity.
            </p>
          </div>
        </div>
      </Section>
