...
export async function generateMetadata(): Promise<Metadata> {
  const pageData = await fetchFrappeSchemaData({
    name: "hire-web-application-developer-in-usa-canada-uk-|-website-designing-company-|-finbyz-tech",
    type: "webpage"
  })
...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Web Page", "staff-augmentation/web-application-developers");
  const faqsGroup = await getFaqs("Web Page", "staff-augmentation/web-application-developers");
  ...
  return (
    <>
      <main>
        ...
        <BusinessSlider />
        <StructureData name="hire-web-application-developer-in-usa-canada-uk-|-website-designing-company-|-finbyz-tech" type="webpage" />
