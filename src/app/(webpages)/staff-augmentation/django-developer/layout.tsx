...
export async function generateMetadata(): Promise<Metadata> {
  const pageData = await fetchFrappeSchemaData({
    name: "hire-django-developer-in-usa-canada-uk-|-python-django-programming-|-finbyz-tech",
    type: "webpage"
  })
  ...
  return (
    <>
      <main>
        ...
        <BusinessSlider />
        <StructureData name="hire-django-developer-in-usa-canada-uk-|-python-django-programming-|-finbyz-tech" type="webpage" />
        <InquiryForm />
      </main>
