...
export async function generateMetadata(): Promise<Metadata> {
  const pageData = await fetchFrappeSchemaData({
    name: "hire-full-stack-javascript-developing-company-in-usa-canada-uk-|-finbyz-tech",
    type: "webpage"
  })
  ...
  return (
    <>
      <main>
        ...
        <BusinessSlider />
        <StructureData name="hire-full-stack-javascript-developing-company-in-usa-canada-uk-|-finbyz-tech" type="webpage" />
        <InquiryForm />
      </main>
