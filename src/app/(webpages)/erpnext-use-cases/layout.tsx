  ...
  return (
    <>
      ...
      <article itemScope itemType="https://schema.org/WebPage">
        <meta itemProp="name" content="ERPNext Real-World Use Cases Industry-Specific Solutions" />
        <meta itemProp="description" content="Discover how ERPNext transforms operations across diverse industries. Explore real-world use cases in manufacturing, EXIM, logistics, and more with expert implementation from a certified partner." />
      </article>
