...
const flipCards = [
  {
    front: (
      <div className="flex flex-col items-center justify-center gap-3">
        <img src="/images/icon-sales-automation.svg" alt="Customized ERPNext" width={56} height={56} />
  ...
  },
  {
    front: (
      <div className="flex flex-col items-center justify-center gap-3">
        <img src="/images/icon-personalized-touch.svg" alt="ERPNext Implementation" width={56} height={56} />
  ...
  },
  {
    front: (
      <div className="flex flex-col items-center justify-center gap-3">
        <img src="/images/icon-shorter-sales-cycle.svg" alt="Integration Services" width={56} height={56} />
  ...
  },
  {
    front: (
      <div className="flex flex-col items-center justify-center gap-3">
        <img src="/images/icon-improved-service.svg" alt="Support and Maintenance" width={56} height={56} />
  ...
  },
  {
    front: (
      <div className="flex flex-col items-center justify-center gap-3">
        <img src="/images/icon-customer-loyalty.svg" alt="Training and Consultation" width={56} height={56} />
  ...
  },
  {
    front: (
      <div className="flex flex-col items-center justify-center gap-3">
        <img src="/images/icon-resource-optimization.svg" alt="Data Migration" width={56} height={56} />
