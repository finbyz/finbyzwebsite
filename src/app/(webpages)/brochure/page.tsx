  ...
  return (
    <>
      <HeroSection
        ...
        secondaryButton={{
          text: "Contact Us",
          action: contactUrl({ notes: 'We are interested in your company brochure', referer: '/brochure' })
        }}
        heroImage={{
          alt: "Brochure",
      ...
      <BrochureClient brochureItems={brochureItems} aiCrmItems={aiCrmItems} aiAutomationItems={aiAutomationItems} />
