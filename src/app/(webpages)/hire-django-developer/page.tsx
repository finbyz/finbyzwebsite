        ...
        <div className="container-custom py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <FlipCard
              front={
                <div className="flex flex-col items-center justify-center h-full">
                  <Image fill  src="/images/web development.svg" alt="web development" />
            ...
            <FlipCard
              front={
                <div className="flex flex-col items-center justify-center h-full">
                  <Image fill  src="/images/icon-shorter-sales-cycle.svg" alt="Django CMS Development" />
            ...
            <FlipCard
              front={
                <div className="flex flex-col items-center justify-center h-full">
                  <Image fill  src="/images/api development.svg" alt="Django Rest API Development" />
            ...
            <FlipCard
              front={
                <div className="flex flex-col items-center justify-center h-full">
                  <Image fill  src="/images/migration.svg" alt="Django Migration Services" />
            ...
            <FlipCard
              front={
                <div className="flex flex-col items-center justify-center h-full">
                  <Image fill  src="/images/custom Django.svg" alt="Custom Django Development" />
            ...
            <FlipCard
              front={
                <div className="flex flex-col items-center justify-center h-full">
                  <Image fill  src="/images/Supoort.svg" alt="Support & Maintenance" />
      ...
      <Section>
        <div className="container-custom py-8 flex flex-col md:flex-row gap-8 items-center">
          <div className="flex-shrink-0 w-full md:w-1/3 flex justify-center">
            <Image fill  src="/images/django-logo-negative.svg" alt="django-logo-negative" />
          </div>
          ...
          <DjangoAdvantageGrid
            advantages={[
              ...
              },
              {
                ...
                image: '/images/icon-data-analytics.svg',
              ...
              },
              {
                ...
                image: '/images/ser-website-development.svg',
