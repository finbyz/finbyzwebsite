...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "change-auto-email-maximum-limit");
  const faqsGroup = await getFaqs("Code Snippet", "change-auto-email-maximum-limit");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00427" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
