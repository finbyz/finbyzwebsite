...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "increase-size-of-disk-ubuntu-test");
  const faqsGroup = await getFaqs("Code Snippet", "increase-size-of-disk-ubuntu-test");
  ...
  return (
    <>
      ...
      <StructureData name="am9h3b1k2v" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
