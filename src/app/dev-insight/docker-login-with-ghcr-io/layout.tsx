...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "docker-login-with-ghcr-io");
  const faqsGroup = await getFaqs("Code Snippet", "docker-login-with-ghcr-io");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00499" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
