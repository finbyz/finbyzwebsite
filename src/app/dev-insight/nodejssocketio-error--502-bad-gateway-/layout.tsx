...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "nodejssocketio-error--502-bad-gateway-");
  const faqsGroup = await getFaqs("Code Snippet", "nodejssocketio-error--502-bad-gateway-");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00456" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
