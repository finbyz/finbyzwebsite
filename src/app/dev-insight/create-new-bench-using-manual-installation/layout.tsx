...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "create-new-bench-using-manual-installation");
  const faqsGroup = await getFaqs("Code Snippet", "create-new-bench-using-manual-installation");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00451" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
