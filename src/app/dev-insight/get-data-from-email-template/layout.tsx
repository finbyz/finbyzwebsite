...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "get-data-from-email-template");
  const faqsGroup = await getFaqs("Code Snippet", "get-data-from-email-template");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00444" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
