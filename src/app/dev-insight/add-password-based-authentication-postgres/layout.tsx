...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "add-password-based-authentication-postgres");
  const faqsGroup = await getFaqs("Code Snippet", "add-password-based-authentication-postgres");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00476" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
