...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "row-size-too-large----8126---changing-some-columns-to-text-or-blob-may-help-");
  const faqsGroup = await getFaqs("Code Snippet", "row-size-too-large----8126---changing-some-columns-to-text-or-blob-may-help-");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00481" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
