...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "permission-denied-supervisor");
  const faqsGroup = await getFaqs("Code Snippet", "permission-denied-supervisor");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00461" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
