...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "check-the-database-size");
  const faqsGroup = await getFaqs("Code Snippet", "check-the-database-size");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00465" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
