...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "eie-update-error-v13");
  const faqsGroup = await getFaqs("Code Snippet", "eie-update-error-v13");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00437" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
