...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "mysql-check-and-repair-all-tables");
  const faqsGroup = await getFaqs("Code Snippet", "mysql-check-and-repair-all-tables");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00428" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
