...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "set-password-once-in-password-based-authentication-instances");
  const faqsGroup = await getFaqs("Code Snippet", "set-password-once-in-password-based-authentication-instances");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00446" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
