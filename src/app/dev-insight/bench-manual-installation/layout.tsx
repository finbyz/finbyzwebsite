...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "bench-manual-installation");
  const faqsGroup = await getFaqs("Code Snippet", "bench-manual-installation");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00449" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
