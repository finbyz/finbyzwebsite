...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "obfuscate-code");
  const faqsGroup = await getFaqs("Code Snippet", "obfuscate-code");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00493" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
