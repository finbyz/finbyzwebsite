...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "whatsapp-integration");
  const faqsGroup = await getFaqs("Code Snippet", "whatsapp-integration");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00480" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
