...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "update-node-and-npm");
  const faqsGroup = await getFaqs("Code Snippet", "update-node-and-npm");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00425" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
