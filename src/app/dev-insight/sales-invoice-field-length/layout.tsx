...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "sales-invoice-field-length");
  const faqsGroup = await getFaqs("Code Snippet", "sales-invoice-field-length");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00479" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
