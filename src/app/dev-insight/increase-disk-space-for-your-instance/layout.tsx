...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "increase-disk-space-for-your-instance");
  const faqsGroup = await getFaqs("Code Snippet", "increase-disk-space-for-your-instance");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00448" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
