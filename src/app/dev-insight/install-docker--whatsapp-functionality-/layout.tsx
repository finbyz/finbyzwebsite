...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "install-docker--whatsapp-functionality-");
  const faqsGroup = await getFaqs("Code Snippet", "install-docker--whatsapp-functionality-");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00424" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
