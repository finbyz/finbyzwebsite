...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "manual-sql-backup-and-restore");
  const faqsGroup = await getFaqs("Code Snippet", "manual-sql-backup-and-restore");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00442" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
