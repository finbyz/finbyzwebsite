...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "email-queue-send-mail-resume-error");
  const faqsGroup = await getFaqs("Code Snippet", "email-queue-send-mail-resume-error");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00445" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
