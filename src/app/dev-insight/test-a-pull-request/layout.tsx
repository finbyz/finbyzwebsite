...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "test-a-pull-request");
  const faqsGroup = await getFaqs("Code Snippet", "test-a-pull-request");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00164" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
