...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "ssh-copy-id-alternative-for-windows");
  const faqsGroup = await getFaqs("Code Snippet", "ssh-copy-id-alternative-for-windows");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00474" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
