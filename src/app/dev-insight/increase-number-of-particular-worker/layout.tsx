...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "increase-number-of-particular-worker");
  const faqsGroup = await getFaqs("Code Snippet", "increase-number-of-particular-worker");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00443" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
