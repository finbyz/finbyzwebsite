...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "add-row-in-tax-withholding-category-for-new-fiscal-year");
  const faqsGroup = await getFaqs("Code Snippet", "add-row-in-tax-withholding-category-for-new-fiscal-year");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00485" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
