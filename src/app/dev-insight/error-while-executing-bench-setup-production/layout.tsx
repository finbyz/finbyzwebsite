...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "error-while-executing-bench-setup-production");
  const faqsGroup = await getFaqs("Code Snippet", "error-while-executing-bench-setup-production");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00467" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
