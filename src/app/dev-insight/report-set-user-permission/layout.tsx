...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "report-set-user-permission");
  const faqsGroup = await getFaqs("Code Snippet", "report-set-user-permission");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00496" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
