...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "download-backup-directly-from-site");
  const faqsGroup = await getFaqs("Code Snippet", "download-backup-directly-from-site");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00488" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
