...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "patch-for-outstanding-amount");
  const faqsGroup = await getFaqs("Code Snippet", "patch-for-outstanding-amount");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00486" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
