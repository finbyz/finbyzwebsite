...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "multiselectlist-field-default-value-set");
  const faqsGroup = await getFaqs("Code Snippet", "multiselectlist-field-default-value-set");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00489" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
