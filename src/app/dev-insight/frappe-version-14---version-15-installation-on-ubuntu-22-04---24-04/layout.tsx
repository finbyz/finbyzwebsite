...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "frappe-version-14---version-15-installation-on-ubuntu-22-04---24-04");
  const faqsGroup = await getFaqs("Code Snippet", "frappe-version-14---version-15-installation-on-ubuntu-22-04---24-04");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00494" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
