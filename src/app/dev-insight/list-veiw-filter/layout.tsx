...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "list-veiw-filter");
  const faqsGroup = await getFaqs("Code Snippet", "list-veiw-filter");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00472" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
