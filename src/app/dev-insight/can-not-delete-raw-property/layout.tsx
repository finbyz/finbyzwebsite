...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "can-not-delete-raw-property");
  const faqsGroup = await getFaqs("Code Snippet", "can-not-delete-raw-property");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00436" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
