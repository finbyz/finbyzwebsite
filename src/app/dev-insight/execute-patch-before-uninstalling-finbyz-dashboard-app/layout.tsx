...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "execute-patch-before-uninstalling-finbyz-dashboard-app");
  const faqsGroup = await getFaqs("Code Snippet", "execute-patch-before-uninstalling-finbyz-dashboard-app");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00440" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
