...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "install-python3-11-on-ubuntu-22-04");
  const faqsGroup = await getFaqs("Code Snippet", "install-python3-11-on-ubuntu-22-04");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00473" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
