...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "increase-the-width-size--in-msgprint-dialog");
  const faqsGroup = await getFaqs("Code Snippet", "increase-the-width-size--in-msgprint-dialog");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00453" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
