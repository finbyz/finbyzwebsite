...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "linux-port-forwarding-to-another-server");
  const faqsGroup = await getFaqs("Code Snippet", "linux-port-forwarding-to-another-server");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00454" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
