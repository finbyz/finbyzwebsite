...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "exim-field-for-non-chemical-company");
  const faqsGroup = await getFaqs("Code Snippet", "exim-field-for-non-chemical-company");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00460" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
