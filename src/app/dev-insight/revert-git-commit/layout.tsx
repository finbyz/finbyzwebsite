...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "revert-git-commit");
  const faqsGroup = await getFaqs("Code Snippet", "revert-git-commit");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00484" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
