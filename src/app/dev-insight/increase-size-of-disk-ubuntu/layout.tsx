...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "increase-size-of-disk-ubuntu");
  const faqsGroup = await getFaqs("Code Snippet", "increase-size-of-disk-ubuntu");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00487" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
