...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "get-default-fiscal-year-date");
  const faqsGroup = await getFaqs("Code Snippet", "get-default-fiscal-year-date");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00431" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
