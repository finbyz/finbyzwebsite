...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "check-erpnext-version-from-console-");
  const faqsGroup = await getFaqs("Code Snippet", "check-erpnext-version-from-console-");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00430" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
