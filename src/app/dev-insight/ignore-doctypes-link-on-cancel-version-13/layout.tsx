...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "ignore-doctypes-link-on-cancel-version-13");
  const faqsGroup = await getFaqs("Code Snippet", "ignore-doctypes-link-on-cancel-version-13");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00438" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
