...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "check-cron--schedular--logs");
  const faqsGroup = await getFaqs("Code Snippet", "check-cron--schedular--logs");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00450" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
