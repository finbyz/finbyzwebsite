...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "komal-version-bench-update");
  const faqsGroup = await getFaqs("Code Snippet", "komal-version-bench-update");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00497" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
