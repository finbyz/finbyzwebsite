...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "set-mysql-remote-connection");
  const faqsGroup = await getFaqs("Code Snippet", "set-mysql-remote-connection");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00159" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
