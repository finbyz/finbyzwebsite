...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "assets-not-loading");
  const faqsGroup = await getFaqs("Code Snippet", "assets-not-loading");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00462" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
