...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "generate--pfx-certificate-self-signed-");
  const faqsGroup = await getFaqs("Code Snippet", "generate--pfx-certificate-self-signed-");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00490" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
