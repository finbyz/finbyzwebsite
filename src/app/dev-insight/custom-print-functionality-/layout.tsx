...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "custom-print-functionality-");
  const faqsGroup = await getFaqs("Code Snippet", "custom-print-functionality-");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00429" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
