...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "regenerate-authentication-of-2fa");
  const faqsGroup = await getFaqs("Code Snippet", "regenerate-authentication-of-2fa");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00422" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
