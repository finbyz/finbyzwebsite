...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "change-python-version-in-system");
  const faqsGroup = await getFaqs("Code Snippet", "change-python-version-in-system");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00468" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
