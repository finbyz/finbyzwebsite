...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "connect-to-frappe-cloud");
  const faqsGroup = await getFaqs("Code Snippet", "connect-to-frappe-cloud");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00466" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
