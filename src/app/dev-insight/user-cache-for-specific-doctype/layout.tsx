...
export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Code Snippet", "user-cache-for-specific-doctype");
  const faqsGroup = await getFaqs("Code Snippet", "user-cache-for-specific-doctype");
  ...
  return (
    <>
      ...
      <StructureData name="SNI-00455" type="code-snippet" />  
      <BusinessSlider />
    </>
  );
}
