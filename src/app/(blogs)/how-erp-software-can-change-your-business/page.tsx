      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 py-12 mx-auto w-full bg-muted/30 border-b max-w-screen-xl">
        ...
        <BlogContent>
          <BlogSectionWithImage
            ...
            title="Introduction"
            image={{
              src: '/api/fb/n/files/erp-can-change-your-business.svg',
          ...
          <BlogSectionWithImage
            ...
            image={{
              src: '/api/fb/n/files/blog-increases-supply-chain-visibility.svg',
          ...
          <BlogSectionWithImage
            ...
            image={{
              src: '/api/fb/n/files/blog-improves-productivity.svg',
          ...
          <BlogSectionWithImage
            ...
            image={{
              src: '/api/fb/n/files/blog-provides-real-time-data.svg',
          ...
          <BlogSectionWithImage
            ...
            image={{
              src: '/api/fb/n/files/blog-decreases-costs.svg',
              alt: 'Decreases Costs',
          ...
          <BlogSectionWithImage
            ...
            image={{
              src: '/api/fb/n/files/blog-customer-service.svg',
          ...
          <BlogSection id="erp-benefits-image" title="Top Benefits of Implementing ERP Software">
            <div className="flex justify-center py-6 animate-fade-in">
              <Image
                src="/api/fb/n/files/benefits-of-erp-imlementing.png"
