      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 py-12 mx-auto w-full bg-muted/30 border-b container-custom">
        ...
        <BlogContent>
          ...
          <BlogSectionWithImage
            ...
            image={{
              src: '/images/website-design-tips-for-a-small-business.svg',
          ...
          <BlogSectionWithImage
            ...
            image={{
              src: '/images/simple-yet-elegant.svg',
          ...
          <BlogSectionWithImage
            ...
            image={{
              src: '/images/dont-ignore-the-mobile-experience.svg.svg',
          ...
          <BlogSectionWithImage
            ...
            image={{
              src: '/images/make-use-of-clear-call-to-action.svg',
