...
const pageData = await fetchFrappeSchemaData({
    name: "erp-options-for-trading-commodities-using-insight-and-efficiency",
    type: "blog"
})
return {
...
export default async function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      ...
      <LazyBusinessSlider />
      <StructureData name="erp-options-for-trading-commodities-using-insight-and-efficiency" type="blog" />
    </>
  );
}
