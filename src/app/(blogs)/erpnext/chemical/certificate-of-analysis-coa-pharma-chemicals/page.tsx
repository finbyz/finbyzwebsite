...
const tocItems = [
  ...
  { id: 'coa-vs-coc', title: 'COA vs COC vs COQ: Key Differences' },
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-blue-50 dark:bg-blue-950/30 border-l-4 border-blue-600 p-6 my-8 container-custom">
        ...
        <p className="text-blue-700 dark:text-blue-300">
          A <strong>Certificate of Analysis (COA)</strong> is an official document issued by manufacturers or laboratories that verifies a product meets specified quality and safety standards. It contains detailed test results confirming compliance with regulatory requirements—essential for pharmaceuticals, chemicals, food, and manufacturing industries.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 py-12 mx-auto w-full bg-muted/30 border-b container-custom">
        ...
        <BlogContent>
          ...
          {/* COA vs COC vs COQ Comparison */}
          <BlogSection id="coa-vs-coc" title="COA vs COC vs COQ: Understanding the Differences">
            <BlogParagraph>
              Many industries use similar-sounding quality documents. Here's how they differ:
            </BlogParagraph>
              ...
              <table className="w-full border-collapse bg-card rounded-lg overflow-hidden shadow-sm">
                <thead>
                  <tr className="bg-primary text-primary-foreground">
                    <th className="p-4 text-left font-semibold">Document</th>
                    <th className="p-4 text-left font-semibold">Full Form</th>
                    <th className="p-4 text-left font-semibold">Purpose</th>
                    <th className="p-4 text-left font-semibold">Primary Use Cases</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-border">
                  <tr className="hover:bg-muted/50 transition-colors">
                    <td className="p-4 font-medium">COA</td>
                    <td className="p-4">Certificate of Analysis</td>
                    <td className="p-4">Verifies product composition and quality through lab testing</td>
                    <td className="p-4">Pharmaceuticals, Chemicals, Food, Raw Materials</td>
                  </tr>
                  <tr className="hover:bg-muted/50 transition-colors">
                    <td className="p-4 font-medium">COC</td>
                    <td className="p-4">Certificate of Conformance</td>
                    <td className="p-4">Confirms product meets design specifications and standards</td>
                    <td className="p-4">Manufacturing, Engineering, Construction</td>
                  </tr>
                  <tr className="hover:bg-muted/50 transition-colors">
                    <td className="p-4 font-medium">COQ</td>
                    <td className="p-4">Certificate of Quality</td>
                    <td className="p-4">General statement of quality assurance (less specific than COA)</td>
                    <td className="p-4">General Manufacturing, Export Documentation</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="bg-amber-50 dark:bg-amber-950/30 p-6 rounded-lg border border-amber-200 dark:border-amber-800 my-6">
              <h4 className="font-semibold text-amber-800 dark:text-amber-200 mb-2">FDA Requirements for Certificate of Analysis</h4>
              <p className="text-sm text-amber-700 dark:text-amber-300">
                The FDA requires COAs for pharmaceutical and food products to include specific test results, batch numbers, expiration dates, and authorized signatures. COAs must be generated by accredited laboratories using validated testing methods that comply with cGMP (current Good Manufacturing Practices) standards.
              </p>
            </div>
          </BlogSection>
