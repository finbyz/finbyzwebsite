...
const pageData = await fetchFrappeSchemaData({
    name: "streamlining-business-operations-with-erpnext-a-comprehensive-guide",
    type: "blog"
})
return {
...
export default async function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      ...
      <BusinessSlider />
      <StructureData name="streamlining-business-operations-with-erpnext-a-comprehensive-guide" type="blog" />
    </>
  );
}
