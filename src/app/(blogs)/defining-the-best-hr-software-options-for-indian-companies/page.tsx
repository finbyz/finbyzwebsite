      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 py-12 mx-auto w-full bg-muted/30 border-b max-w-screen-xl">
        ...
        <BlogContent>
          ...
          <BlogSectionWithImage
            ...
            image={{
              src: '/api/fb/n/files/estimation-of-cost.svg',
          ...
          <BlogSection id="important-factors" title="Important Factors to Consider">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
              ...
              <div className="flex flex-col items-center bg-background rounded-xl shadow-sm p-6 transition-transform hover:scale-105 duration-300">
                <Image src="/api/fb/n/files/payroll.svg" alt="Payroll Management" title="Payroll Management" width={120} height={120} className="mb-4" />
              ...
              <div className="flex flex-col items-center bg-background rounded-xl shadow-sm p-6 transition-transform hover:scale-105 duration-300">
                <Image src="/api/fb/n/files/employee-attendance.svg" alt="Employee Self-Service" title="Employee Self-Service" width={120} height={120} className="mb-4" />
              ...
              <div className="flex flex-col items-center bg-background rounded-xl shadow-sm p-6 transition-transform hover:scale-105 duration-300">
                <Image src="/api/fb/n/files/380.svg" alt="Reporting and Analytics" title="Reporting and Analytics" width={120} height={120} className="mb-4" />
              ...
              <div className="flex flex-col items-center bg-background rounded-xl shadow-sm p-6 transition-transform hover:scale-105 duration-300">
                <Image src="/api/fb/n/files/icon-tl-revamp.svg" alt="Integration Capabilities" title="Integration Capabilities" width={120} height={120} className="mb-4" />
              ...
              <div className="flex flex-col items-center bg-background rounded-xl shadow-sm p-6 transition-transform hover:scale-105 duration-300">
                <Image src="/api/fb/n/files/Security3b8a73.svg" alt="Compliance and Security" title="Compliance and Security" width={120} height={120} className="mb-4" />
              ...
              <div className="flex flex-col items-center bg-background rounded-xl shadow-sm p-6 transition-transform hover:scale-105 duration-300">
                <Image src="/api/fb/n/files/69.svg" alt="User Feedback and Reviews" title="User Feedback and Reviews" width={120} height={120} className="mb-4" />
