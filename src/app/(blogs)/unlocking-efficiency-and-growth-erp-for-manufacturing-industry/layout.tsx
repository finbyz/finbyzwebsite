...
const pageData = await fetchFrappeSchemaData({
    name: "unlocking-efficiency-and-growth-erp-for-manufacturing-industry",
    type: "blog"
})
return {
...
export default async function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      ...
      <BusinessSlider />
      <StructureData name="unlocking-efficiency-and-growth-erp-for-manufacturing-industry" type="blog" />
    </>
  );
}
