...
const pageData = await fetchFrappeSchemaData({
    name: "the-top-10-erp-software-companies-revolutionizing-business-operations",
    type: "blog"
})
return {
...
export default async function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      ...
      <LazyBusinessSlider />
      <StructureData name="the-top-10-erp-software-companies-revolutionizing-business-operations" type="blog" />
    </>
  );
}
