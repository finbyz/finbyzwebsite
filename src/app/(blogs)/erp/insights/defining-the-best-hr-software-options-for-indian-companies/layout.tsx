...
const pageData = await fetchFrappeSchemaData({
    name: "defining-the-best-hr-software-options-for-indian-companies",
    type: "blog"
})
return {
...
export default async function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      ...
      <LazyBusinessSlider />
      <StructureData name="defining-the-best-hr-software-options-for-indian-companies" type="blog" />
    </>
  );
}
