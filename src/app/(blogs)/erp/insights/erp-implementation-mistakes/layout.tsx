...
const pageData = await fetchFrappeSchemaData({
    name: "erp-implementation-mistakes",
    type: "blog"
})
return {
...
const faqsGroup = await getFaqs("Blog Post", "erp/insights/erp-implementation-mistakes");

export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Blog Post", "erp/insights/erp-implementation-mistakes");
  ...
  return (
    <>
      ...
      <LazyBusinessSlider />
      <StructureData name="erp-implementation-mistakes" type="blog" />
    </>
  );
}
