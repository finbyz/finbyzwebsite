...
const pageData = await fetchFrappeSchemaData({
    name: "challenges-of-erp-implementation",
    type: "blog"
})
return {
...
const faqsGroup = await getFaqs("Blog Post", "erp/insights/challenges-of-erp-implementation");

export default async function Layout({ children }: { children: React.ReactNode }) {
  const data = await getPageData("Blog Post", "erp/insights/challenges-of-erp-implementation");
  ...
  return (
    <>
      ...
      <LazyBusinessSlider />
      <StructureData name="challenges-of-erp-implementation" type="blog" />
    </>
  );
}
