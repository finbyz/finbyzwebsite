...
// ============================================================================
// DYNAMIC PAGE: ERP-FOR-CHEMICAL-INDUSTRY4
// ============================================================================

export default function ErpForChemicalIndustry4Page() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <SectionsBasedRenderer
        ...
        className="dynamic-page-erp-for-chemical-industry4"
      />
      ...
      <div className="fixed bottom-4 right-4 z-50 bg-white/90 backdrop-blur-sm border border-gray-200 rounded-lg p-4 shadow-lg max-w-xs">
        ...
        <div className="text-xs text-gray-600 space-y-1">
          <div>Page: erp-for-chemical-industry4</div>
