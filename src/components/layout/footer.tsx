      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="col-span-2">
            <h3 className="text-2xl font-bold mb-4">Finbyz.tech</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-slate-300">
              <li><a href="#" className="hover:text-white transition-colors">ERP Implementation</a></li>
              ...
              <li><a href="#" className="hover:text-white transition-colors">Resource Augmentation</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-slate-800 mt-12 pt-8 text-center text-slate-400">
          <p>&copy; 2024 Finbyz.tech. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
