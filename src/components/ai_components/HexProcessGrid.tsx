      ...
      {steps.map((step, idx) => (
        ...
        >
          <div className="relative flex flex-col items-center">
            <div className="w-52 h-36 flex items-center justify-center relative">
            <span className="absolute -top-4 -right-4 bg-primary text-black rounded-full w-8 h-8 flex items-center justify-center font-bold shadow-lg border-2 border-white z-20">
