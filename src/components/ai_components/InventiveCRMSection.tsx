...
const InventiveCRMSection: React.FC = () => (
  <Section>
    <div className="container-custom py-8">
      <h2 className="text-3xl font-bold text-center mb-8">Inventive in CRM Software</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="flex flex-col items-center text-center">
          <h3 className="text-xl font-semibold mb-2">Innovative CRM Software Solutions</h3>
          <Image src="/api/fb/n/files/61.svg" alt="Custom-Software-Solution" width={150} height={50} className="mb-4" />
          <p>
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <Image src="/api/fb/n/files/170%20(1).svg" alt="Erp-Implementation" width={150} height={50} className="mb-4" />
          <p>
