    ...
    <div className="container-custom py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p>
            Leveraging our expertise in <a href="/erp/services/erp-software-development" className="text-primary underline">ERP Implementation</a> and CRM systems, we build stronger, meaningful connections between businesses and their clients. Our approach focuses on understanding customer behavior and preferences, enabling tailored services and communication.
          </p>
        </div>
      </div>
    </div>
